...
document.addEventListener('DOMContentLoaded', () => {
  ...
  setTimeout(() => {
    ...
    if (onGuidePage) {
      ...
      // *************************************************************************
      // we are on an individual event page
    } else {
  ...
  // 2) TEST- write code to change times on individual event page
  // 3) write code to change times below calendar (white calender box)
  // 4) Refactor format time zone functions- consolidate into 1 function
  // 5) Format times below calendar ("PM" and "AM")
